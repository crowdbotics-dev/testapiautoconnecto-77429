...
## Project Structure
    ...
    ├── testapiautoconnecto_77429  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_77429`
...
2. Clone this repo and `cd testapiautoconnecto_77429`
